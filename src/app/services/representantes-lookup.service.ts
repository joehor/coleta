...
export class RepresentantesLookupService {

  constructor( private httpclient: HttpClient, httpparams: HttpParams ) { }

  getData(pesq: string, page: number, pagecnt: number) {
    ...
    return this.httpclient.get<DataApi>(`/api/Representantes/Lookup`, { params });
