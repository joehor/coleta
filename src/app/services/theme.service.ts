...
export class ThemeService {
  ...
  setTheme(theme: string) {
    if (theme === 'kappesberg') {
      ...
      document.documentElement.style.setProperty('--main-color-hover', '#e21932');
    ...
    if (theme === 'purple') {
      ...
      document.documentElement.style.setProperty('--main-color-hover', 'whitesmoke');
    ...
    if (theme === 'red') {
      ...
      document.documentElement.style.setProperty('--main-color-hover', 'rgb(166, 12, 40)');
